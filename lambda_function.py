...
def lambda_handler(event, context):
    ...
    optGuideFile = '/tmp/xmlguide.xmltv'
    optLanguage = 'en'
    
    # Create an instance of the Zap2ItGuideScrape class
    guide = Zap2ItGuideScrape(optConfigFile,optGuideFile)

    # Scrape the guide and save to the specified output file
    guide.BuildGuide()


    client = boto3.client('s3')
    client.upload_file('/tmp/xmlguide.xmltv', 'S3_BUCKET_NAME', 'xmltv.xml', ExtraArgs={'ACL': 'public-read'})
